...
echo "<center><div class=\"addform\"><form method='get' action=\"add_student_admin.php\">\n";
...
echo "</tr>";
echo "<tr>\n";
echo "<td><center><input type=\"text\" size=\"7\" name=\"RNumber\" value=\"" . $data1['RNumber'] . "\" /></center></td>\n";
...
echo "<td><center><input type=\"text\" size=\"10\" name=\"Instructor\" value=\"" . $data1['Instructor'] . "\" /></center></td>\n";
echo "<td><center><input type=\"text\" size=\"4\" name=\"Course\" value=\"" . $data1['Course'] . "\" /></center></td>\n";
...
echo "<td><center><input type=\"text\" size=\"7\" name=\"Date\" value=\"" . date('Y-m-d') . "\" /></center></td>\n";
echo "<td><center><input type=\"text\" size=\"4\" name=\"StartTime\" value=\"" . date('H:i:s') . "\" /></center></td>\n";
...
if ($count !== 0) {
    while ($data = mysql_fetch_array($result)) {
        ...
        echo "<tr>\n";
        echo "<form name=\"updateForm\" id=\"updateForm\" method=\"get\" action=\"update_student_admin.php\">\n";
...
</td></form></tr><tr><td colspan=\"14\" bgcolor=\"FF0000\" height=\"5px\"></td></tr>\n\n";
    }
    echo "</table><br />\n";
} else {
