...
<head>
    ...
    <script type="text/javascript">
        function showInstructor(str) {
            ...
            xmlhttp.open("GET", "instructor_process.php?q=" + str, true);
            xmlhttp.send();
        }
...
<div class="content">
    <br/>
<br/>
<strong>Outstanding Transactions</strong>
<br/>
<br/>
...
<?php
    ...
    echo "<div class=\"addform\"><form method='get' id=\"Checkoutform\" action=\"add.php\">\n";
    ...
    echo "	<tr align=\"center\"><td><input id=\"Barcode\" type=\"text\" size=\"40\" name=\"Description\"/></td>\n" .
...
Checkoutform.Barcode.focus();
</script>";

	//This filters out all transactions where equipment has already been checked in
    $result = mysql_query("select * FROM langlab.transactions WHERE langlab.transactions.CheckinDate IS NULL or langlab.transactions.CheckinDate ='0000-00-00' order by Trans_ID DESC");
    
    $count = mysql_num_rows($result);

	//This form allows you to check in equipment that has been returned
